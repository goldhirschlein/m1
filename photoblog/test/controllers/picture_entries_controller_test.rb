...
class PictureEntriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create picture_entry" do
    assert_difference('PictureEntry.count') do
      post picture_entries_url, params: { picture_entry: { datetime: @picture_entry.datetime, datetime: @picture_entry.datetime, description: @picture_entry.description, location: @picture_entry.location, picture: @picture_entry.picture, title: @picture_entry.title } }
    end
  ...
  test "should update picture_entry" do
    patch picture_entry_url(@picture_entry), params: { picture_entry: { datetime: @picture_entry.datetime, datetime: @picture_entry.datetime, description: @picture_entry.description, location: @picture_entry.location, picture: @picture_entry.picture, title: @picture_entry.title } }
